...
public class RouteListFragment extends ListFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_route_list,
				container, false);
	...
	public void onClick(View v) {
		Toast.makeText(getActivity(), "Navigation Mode", Toast.LENGTH_SHORT)
				.show();

		// TODO
		// Navigation navigation = Navigation.getInstance();
		// navigation.initiateRoutes(getActivity(),
		// mListTrayekRouteDetail.get(0)
		// .getIdWaypoint() + "");
		// navigation.redraw();
